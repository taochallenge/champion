  ...
  render() {
    ...
    return (
      <div className='daka'>
        ...
        <div className='rili' style={{ backgroundColor: 'white', width: '100%', height: '45%' }}>
          <table>
            <tbody>
              <tr>
                {weeks.map(el => (
                ...
                return (
                  <tr key={i}>
                    {el.map((dateItem, j) => {
                      ...
                      let isSignIn = dateItem.isSignIn;
                      let isShowSignIn = dateItem.isShowSignIn;
                        ...
                        // })
                        // .then(res=>res.json())
                        // .then(res=>{this.state.hlist[i][j].isSignIn=res[0].state})
