        ...
        return (
            <div className="con">
                ...
                <div className="cont-1">
                    ...
                    <div className="img-1">
                        <div className="img-2"><img src={qq} /> <div className="txt-2">QQ邀请</div></div>
                        <div className="img-2"><img src={weixin} /><div className="txt-2">qq邀请</div></div>
                        <div className="img-2"><img src={email} /><div className="txt-2">短信邀请</div></div>
                    </div>
                    <div className="line"></div>
                    <div className="txt-3">TA已注册，填写TA的配对码</div>
                    <div className="recode">
                        <input className="ver" placeholder="请输入TA的配对码"></input>
                        <button className="but">绑定</button>
                    </div>
                </div>
            </div>
        )
