  ...
  render() {
    return (
      <div id='UsersupDiv'>
        ...
        <div className='UsersupInp'>
          <p>羡慕人数:</p>
          <input type='number' value={this.state.countadmire} onChange={this.AddCountadmire} placeholder='请输入羡慕人数' />
        </div>
        <div className='UsersupInp'>
          <p>是否被收藏:</p>
          <input type="text" value={this.state.collect} onChange={this.AddCollect} placeholder="请输入是否被收藏" />
        </div>
        <div className='UsersupInp'>
          <p>种树创作者:</p>
